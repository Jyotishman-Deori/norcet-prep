...
const STATIC_REGISTRY = [
  ...
  // The JSON "Export my data" download was removed (DPDP has no portability
  // mandate, and a raw dump exposes the data shape). Backup now means cloud
  // sync on sign-in, plus the in-app Recently deleted restore. No export.
  { id: 'backup', title: 'Backup & sync', category: 'Settings',
    keywords: ['backup', 'sync', 'restore', 'cloud', 'account', 'data', 'transfer'],
    route: { screen: 'settings' },
    description: 'Sign in to keep your progress backed up across devices.' },
  ...
  { id: 'about', title: 'About NurseHolic', category: 'Settings',
    keywords: ['about', 'mission', 'story', 'team', 'developer', 'app', 'contact', 'nurseholic'],
    route: { screen: 'about' },
  ...
  { id: 'nursing-calc', title: 'Nursing Calculator Suite', category: 'Features',
  ...
  { id: 'dosage', title: 'Nursing Calc Test', category: 'Features',
    keywords: ['calc', 'calculation', 'nursing calc', 'dosage', 'dose', 'drip', 'math', 'formula', 'bmi', 'bsa', 'gcs', 'apgar', 'map', 'fluids', 'conversion'],
    route: { screen: 'dosage' },
    description: 'Type-in calculations from across the Calculator Suite.' },
