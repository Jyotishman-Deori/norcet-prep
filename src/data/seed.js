...
export const DEFAULT_DATA = {
  ...
  // lib/levelup.js.
  levelup: { xp: 0, dailyDate: '', dailyXp: 0, dailyGames: 0, questClaims: [], crates: 0, cosmetics: [], frame: 'none' },
  ...
  preferences: {          // remembers user choices
    ...
    drillCoaching: { vitalsCheck: true, codeBlue: true, ghostShift: true, whatIf: true },
