...
export const STUDY_METHODS = [
  ...
  },
  {
    ...
    application: 'After reading about a drug mechanism, stop and ask: why does this drug work this way? What does it do to the body? If you cannot answer it, you do not understand it yet. The Knowledge Map helps you see how every topic connects.',
    nav: { screen: 'knowledge-map' },
    goLabel: 'Open the Knowledge Map',
    statKind: 'accuracy',
  },
  {
    id: 'recall',
  ...
  },
  {
    ...
    application: 'Instead of two hours of anatomy, do 20 minutes of anatomy, then pharmacology, then medical-surgical, then back. A full mock test does exactly this for you — it pulls questions from every subject at once.',
    nav: { screen: 'mock-setup' },
    goLabel: 'Start a mock test',
    statKind: 'coverage',
  },
  {
    id: 'testing',
    ...
    application: 'After every unit, attempt questions immediately — even if you just studied and feel unsure. Getting them wrong is not failure; it is the most efficient learning there is. Previous-year papers are the truest test of whether it stuck.',
    nav: { screen: 'previous-papers' },
    goLabel: 'Try a previous paper',
    statKind: 'streak',
  },
];
