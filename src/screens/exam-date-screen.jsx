// =====================================================================
// src/screens/exam-date-screen.jsx — exam date / daily target setup (A1 slice 21)
// Extracted from App.jsx. Body byte-identical; changes are the A7 hook lines
// and the signature dropping `data` (now from useData). Other props stay
// (allQuestionsCount, onSave, onClear, onSaveTarget, onBack). T -> useTheme.
// =====================================================================
