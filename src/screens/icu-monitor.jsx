      ...
      <div className="anim-fadeup">
        ...
        <div className="max-w-md mx-auto px-4 pt-2 pb-32">
          ...
          <div className="rounded-2xl p-3.5 mb-5 space-y-2" style={{ background: T.surfaceWarm, border: `1px solid ${T.borderSoft}` }}>
            {['Watch the live ECG trace and the vitals', 'Name the rhythm from the four options', 'Learn the first clinical action after each'].map((s, i) => (
              <div key={i} className="flex items-start gap-2.5">
                <span className="w-5 h-5 rounded-full flex items-center justify-center text-[10px] font-bold flex-shrink-0 mt-0.5" style={{ background: TEAL + '18', color: TEAL }}>{i + 1}</span>
