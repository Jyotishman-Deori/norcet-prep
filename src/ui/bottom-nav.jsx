...
// Slot layout (index 2 is the raised "+", not a route).
const TABS = [
  { screen: 'home',      label: 'Home',       Icon: House,    slot: 0 },
  { screen: 'search',    label: 'Search',     Icon: Search,   slot: 1 },
  { screen: 'favorites', label: 'Favourites', Icon: Heart,    slot: 3 },
  { screen: 'settings',  label: 'Settings',   Icon: Settings, slot: 4 },
];
